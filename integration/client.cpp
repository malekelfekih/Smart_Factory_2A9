...
void client::create_pdf(QString description, QString objet, QString title) {
  QPdfWriter pdf("C:/Users/Malek/Desktop/Smart_Factory_2A9 -/integration/reclamation/reclamation.pdf");
  ...
  // open .pdf file
  QProcess::startDetached(openPath.arg("C:/Users/Malek/Desktop/Smart_Factory_2A9 -/integration/reclamation/reclamation.pdf"));

  // print .pdf file
  QProcess printProcess;
  printProcess.start(printPath.arg("C:/Users/Malek/Desktop/Smart_Factory_2A9 -/integration/reclamation/reclamation.pdf"));
