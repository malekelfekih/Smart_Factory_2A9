...
QString Arduino1::getarduino_port_name() { return arduino_port_name; }

QSerialPort *Arduino1::getserial() { return serial; }
int Arduino1::connect_arduino() { // recherche du port sur lequel la carte
